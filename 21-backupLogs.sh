...
touch -d "15 days ago" /usr/local/bin/source-dir/user.log
touch -d "15 days ago" /usr/local/bin/source-dir/nginx.conf
touch -d "15 days ago" /usr/local/bin/source-dir/app.log
touch -d "15 days ago" /usr/local/bin/source-dir/cart.sh
touch -d "5 days ago" /usr/local/bin/source-dir/payment.log
touch -d "5 days ago" /usr/local/bin/source-dir/catalogue.log
...
echo -e "Debug: Finding *.log files older than $DAYS days in $SOURCE_DIR" | tee -a $LOG_FILE
echo -e "FILES:\n$FILES\n" | tee -a $LOG_FILE
